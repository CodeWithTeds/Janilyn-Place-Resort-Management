<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Exclusive Resort Rental') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('owner.resort-management.exclusive-resort-rentals.update', $rental) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                @if($rental->image_path)
                                    <div class="mt-2" x-show="!photoPreview">
                                        <div class="relative w-full h-56 rounded-lg overflow-hidden mb-4 border border-gray-200 shadow-sm group">
                                            <img src="{{ asset('storage/' . $rental->image_path) }}" alt="{{ $rental->name }}" class="w-full h-full object-cover">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 max-w-md mx-auto">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <x-input id="name" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm transition-colors duration-200" type="text" name="name" :value="old('name', $rental->name)" required autofocus placeholder="e.g. Resort Rental + 3 Apartments" />
                                        <x-input-error for="name" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-label for="description" value="{{ __('Description (e.g., Bedrooms count)') }}" class="font-medium text-gray-700" />
                                        <textarea id="description" name="description" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm block mt-2 w-full transition-colors duration-200" rows="3" placeholder="e.g. (6 Bedrooms)">{{ old('description', $rental->description) }}</textarea>
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-input id="price_range_min" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="price_range_min" :value="old('price_range_min', $rental->price_range_min)" required placeholder="10000" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="price_range_max" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="price_range_max" :value="old('price_range_max', $rental->price_range_max)" required placeholder="12000" />
                                        <x-input-error for="price_range_max" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-label for="cooking_fee" value="{{ __('Cooking Fee (₱)') }}" class="font-medium text-gray-700" />
                                        <x-input id="cooking_fee" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="cooking_fee" :value="old('cooking_fee', $rental->cooking_fee)" required placeholder="300" />
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-input id="capacity_overnight_min" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="capacity_overnight_min" :value="old('capacity_overnight_min', $rental->capacity_overnight_min)" placeholder="20" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="capacity_overnight_max" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="capacity_overnight_max" :value="old('capacity_overnight_max', $rental->capacity_overnight_max)" placeholder="30" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="capacity_day_min" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="capacity_day_min" :value="old('capacity_day_min', $rental->capacity_day_min)" placeholder="30" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="capacity_day_max" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="capacity_day_max" :value="old('capacity_day_max', $rental->capacity_day_max)" placeholder="60" />
