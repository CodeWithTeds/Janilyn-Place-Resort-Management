                ...
                <form action="{{ route('resort-management.exclusive-resort-rentals.update', $rental) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1 space-y-6">
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 max-w-md mx-auto" x-data="{ photoName: null, photoPreview: '{{ $rental->image_path ? Storage::url($rental->image_path) : '' }}' }">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 max-w-md mx-auto">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <x-input id="name" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm transition-colors duration-200" type="text" name="name" :value="old('name', $rental->name)" required placeholder="e.g. Entire Resort Exclusive" />
                                    ...
                                    <div>
                                        ...
                                        <select id="category" name="category" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm transition-colors duration-200">
                                            ...
                                            <option value="BAR AREA RENTAL" {{ old('category', $rental->category) == 'BAR AREA RENTAL' ? 'selected' : '' }}>BAR AREA RENTAL</option>
                                            <option value="RESORT RENTAL" {{ old('category', $rental->category) == 'RESORT RENTAL' ? 'selected' : '' }}>RESORT RENTAL</option>
                                            <option value="ENTIRE RESORT" {{ old('category', $rental->category) == 'ENTIRE RESORT' ? 'selected' : '' }}>ENTIRE RESORT</option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="description" name="description" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm block mt-2 w-full transition-colors duration-200" rows="3" placeholder="Description of the exclusive rental package...">{{ old('description', $rental->description) }}</textarea>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100" x-data="{ tiers: {{ $rental->pricingTiers->count() > 0 ? $rental->pricingTiers->toJson() : '[{ min_guests: 1, max_guests: 20, price_weekday: \'\', price_weekend: \'\' }]' }} }">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-input id="extra_person_charge" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="extra_person_charge" :value="old('extra_person_charge', $rental->extra_person_charge)" placeholder="0.00" min="0" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="cooking_fee" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="cooking_fee" :value="old('cooking_fee', $rental->cooking_fee)" placeholder="0.00" min="0" />
