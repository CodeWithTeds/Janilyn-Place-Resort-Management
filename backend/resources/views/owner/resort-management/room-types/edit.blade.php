                ...
                <form action="{{ route('resort-management.room-types.update', $roomType) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100" x-data="{ tiers: {{ $roomType->pricingTiers->count() > 0 ? $roomType->pricingTiers->toJson() : '[{ min_guests: 1, max_guests: 2, price_weekday: \'\', price_weekend: \'\' }]' }} }">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-input id="extra_person_charge" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="extra_person_charge" :value="old('extra_person_charge', $roomType->extra_person_charge)" placeholder="0.00" min="0" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="cooking_fee" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="cooking_fee" :value="old('cooking_fee', $roomType->cooking_fee)" placeholder="0.00" min="0" />
