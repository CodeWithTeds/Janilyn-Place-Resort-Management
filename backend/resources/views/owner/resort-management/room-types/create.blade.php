                ...
                <form action="{{ route('resort-management.room-types.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100" x-data="{ tiers: [{ min_guests: 1, max_guests: 2, price_weekday: '', price_weekend: '' }] }">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                            ...
                            <!-- Capacity Settings Removed as requested -->
