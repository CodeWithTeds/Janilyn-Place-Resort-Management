    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('resort-management.room-types.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 max-w-md mx-auto">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <x-input id="name" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm transition-colors duration-200" type="text" name="name" :value="old('name')" required placeholder="e.g. Deluxe Room" />
                                    ...
                                    <div>
                                        ...
                                        <select id="category" name="category" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm transition-colors duration-200">
                                            ...
                                            <option value="DELUXE ROOM" {{ old('category') == 'DELUXE ROOM' ? 'selected' : '' }}>DELUXE ROOM</option>
                                            <option value="APARTMENT STYLE" {{ old('category') == 'APARTMENT STYLE' ? 'selected' : '' }}>APARTMENT STYLE</option>
                                            <option value="GUEST HOUSE" {{ old('category') == 'GUEST HOUSE' ? 'selected' : '' }}>GUEST HOUSE</option>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="description" name="description" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm block mt-2 w-full transition-colors duration-200" rows="3" placeholder="Room description...">{{ old('description') }}</textarea>
                                        <x-input-error for="description" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-label for="bedroom_count" value="{{ __('Bedroom Count') }}" class="font-medium text-gray-700" />
                                        <x-input id="bedroom_count" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="bedroom_count" :value="old('bedroom_count')" min="0" placeholder="1" />
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-input id="base_price_weekday" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="base_price_weekday" :value="old('base_price_weekday')" required placeholder="0.00" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="base_price_weekend" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="base_price_weekend" :value="old('base_price_weekend')" required placeholder="0.00" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="extra_person_charge" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="extra_person_charge" :value="old('extra_person_charge', 0)" placeholder="0.00" />
                                    ...
                                    <div>
                                        ...
                                        <x-input id="cooking_fee" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" step="0.01" name="cooking_fee" :value="old('cooking_fee', 0)" placeholder="0.00" />
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <x-input id="min_pax" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="min_pax" :value="old('min_pax', 1)" required min="1" placeholder="1" />
                                        <x-input-error for="min_pax" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-label for="max_pax" value="{{ __('Maximum Pax') }}" class="font-medium text-gray-700" />
                                        <x-input id="max_pax" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="max_pax" :value="old('max_pax', 2)" required min="1" placeholder="2" />
                                        <x-input-error for="max_pax" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-label for="max_day_guests" value="{{ __('Max Day Guests') }}" class="font-medium text-gray-700" />
                                        <x-input id="max_day_guests" class="block mt-2 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm" type="number" name="max_day_guests" :value="old('max_day_guests')" min="0" placeholder="0" />
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                                ...
                                <div>
                                    ...
                                    <textarea id="amenities" name="amenities" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm block mt-2 w-full transition-colors duration-200" rows="2" placeholder="e.g. WiFi, AC, TV">{{ old('amenities') }}</textarea>
