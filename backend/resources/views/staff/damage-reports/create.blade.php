    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('staff.damage-reports.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex items-center justify-end mt-6">
                        <a href="{{ route('staff.damage-reports.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">Cancel</a>
                        <x-button>
                            {{ __('Submit Report') }}
                        </x-button>
                    </div>
